      ...
      >
        ...
        >
          ...
          <Form.Item
            ...
            initialValue="cloud"
            rules={[
              { required: true, message: "Please select a storage mode" },
            ]}
          >
            <Radio.Group>
                  ...
                  <Space align="start">
                    ...
                    <div>
                      ...
                      <Text
                        ...
                        style={{ fontSize: "12px", display: "block" }}
                      >
                        • Zero-knowledge encrypted manual cloud backup
                      </Text>
                    </div>
                  </Space>
                </Radio>
              ...
              rules={[
                {
                  validator: (_, value) =>
                    value
                      ? Promise.resolve()
                      : Promise.reject(
                          new Error("You must acknowledge the encryption risks")
                        ),
                },
              ]}
            ...
            >
              <Checkbox>
                <Text style={{ fontSize: "13px" }}>
                  I understand that if I <strong>forget my password</strong>, my{" "}
                  <strong>encrypted backup cannot be recovered</strong>
                </Text>
              </Checkbox>
            </Form.Item>
          )}
